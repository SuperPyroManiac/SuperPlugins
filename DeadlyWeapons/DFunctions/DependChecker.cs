...
public class DependChecker
{
    internal static bool Start()
    {
        ...
        {
            Game.Console.Print("Oops there was an error here. Please send this log to https://dsc.PyrosFun.com");
            ...
            Game.DisplayNotification("new_editor", "warningtriangle", "~r~DeadlyWeapons", "~y~Not Loaded!", "Plugin is installed incorrectly! Please see the RagePluginHook.log! Visit https://dsc.PyrosFun.com for help!"); 
            return false;
        }
