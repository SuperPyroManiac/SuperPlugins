...
namespace SuperEvents.SimpleFunctions
{
    internal class VersionChecker
    {
        internal static bool IsUpdateAvailable()
        {
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~y~SuperEvents Warning", "~y~Failed to check for an update", "Please check if you are ~o~online~w~, or try to reload the plugin.");

                Game.Console.Print();
                Game.Console.Print("================================================ SuperEvents WARNING =====================================================");
                Game.Console.Print();
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~r~SuperEvents Warning", "~y~A new Update is available!", "Current Version: ~r~" + curVersion + "~w~<br>New Version: ~g~" + receivedData);

                Game.Console.Print();
                Game.Console.Print("================================================ SuperEvents WARNING =====================================================");
                Game.Console.Print();
                Game.Console.Print("A new version of SuperEvents is available! Update the Version, or play on your own risk.");
