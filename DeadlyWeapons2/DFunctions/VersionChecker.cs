...
namespace DeadlyWeapons2.DFunctions
{
    internal class VersionChecker
    {
        internal static bool IsUpdateAvailable()
        {
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~y~Deadly Weapons Warning",
                    "~y~Failed to check for an update",
                    "Please check if you are ~o~online~w~, or try to reload the plugin.");

                Game.Console.Print();
                Game.Console.Print(
                    "================================================ Deadly Weapons WARNING =====================================================");
                Game.Console.Print();
            ...
            {
                Game.DisplayNotification("commonmenu", "mp_alerttriangle", "~r~Deadly Weapons Warning",
                ...
                Game.Console.Print();
                Game.Console.Print(
                    "A new version of Deadly Weapons is available! Update the Version, or play on your own risk.");
