...
using Rage;
using SuperCalloutsLegacy.Callouts;
using SuperCalloutsLegacy.SimpleFunctions;
using Fire = SuperCalloutsLegacy.Callouts.Fire;

namespace SuperCalloutsLegacy
{
    internal class Main : Plugin
    {
        ...
        private static void RegisterCallouts()
        {
            ...
            if (Settings.Fire) { Functions.RegisterCallout(typeof(Callouts.Fire)); Game.LogTrivial("SuperCallouts: Fire Enabled"); }
            ...
            if (Settings.FakeCall) { Functions.RegisterCallout(typeof(FakeCall)); Game.LogTrivial("SuperCallouts: FakeCall Enabled"); }
            if (Settings.Trespassing) { Functions.RegisterCallout(typeof(Trespassing)); Game.LogTrivial("SuperCallouts: Trespassing Enabled"); }
