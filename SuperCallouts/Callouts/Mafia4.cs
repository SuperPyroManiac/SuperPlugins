...
internal class Mafia4 : Callout
{
    ...
    public override bool OnBeforeCalloutDisplayed()
    {
        ...
        Functions.PlayScannerAudioUsingPosition("ATTENTION_ALL_UNITS_05 WE_HAVE CRIME_SHOTS_FIRED_AT_AN_OFFICER_01 IN_OR_ON_POSITION UNITS_RESPOND_CODE_99_02", _callPos);
    ...
    public override bool OnCalloutAccepted()
    {
        ...
        _peds.Add(_doctor1);
        _peds.Add(_doctor2);
        foreach (var mafiaCars in _vehicles)
