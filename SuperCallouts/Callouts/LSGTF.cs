...
internal class Lsgtf : Callout
{
    ...
    public override bool OnBeforeCalloutDisplayed()
    {
        ...
        Functions.PlayScannerAudioUsingPosition("ATTENTION_ALL_SWAT_UNITS_01 WE_HAVE CRIME_BRANDISHING_WEAPON_01 IN_OR_ON_POSITION", _raidpoint);
    ...
    public override bool OnCalloutAccepted()
    {
        ...
        LsgtfSetup.ConstructLspdraidScene(out _bad1, out _bad2, out _bad3, out _bad4, out _bad5, out _bad6, out _bad7, out _bad8, out _cVehicle, out _fib1, out _fib2);
    ...
    public override void Process()
    {
        ...
        if (_onScene && _bad1.IsDead && _bad2.IsDead && _bad3.IsDead && _bad4.IsDead && _bad5.IsDead && _bad6.IsDead && _bad7.IsDead && _bad8.IsDead)
