...
internal class HitRun : SuperCallout
{
    ...
    internal override void CalloutPrep()
    {
        ...
        Functions.PlayScannerAudioUsingPosition("ATTENTION_ALL_UNITS_05 WE_HAVE CRIME_HIT_AND_RUN_01 IN_OR_ON_POSITION", SpawnPoint.Position);
    }
    ...
    internal override void CalloutAccepted()
    {
        ...
        // Spawn victim vehicle and damage it
        ...
        // Spawn suspect vehicle and damage it
            ...
            GameFiber.StartNew(
                delegate
                {
                    ...
                    Game.DisplaySubtitle(
                        $"~r~{_name1}~s~: I gave the dispatch lady the license number, but it was so fast I don't recall any details. Im sorry, can I leave?",
                        5000
                    );
                    GameFiber.Wait(5000);
        ...
        if (selItem == _speakSuspect2)
        {
            GameFiber.StartNew(
                delegate
                {
                    ...
                    _bad1.PlayAmbientSpeech("GENERIC_CURSE_MED");
                    Game.DisplaySubtitle(
                        $"~r~{_name3}~s~: I didnt do nothing at all, I was just chilling and they hit someone and started running, I was like bro, and they were like bruh, so we dipped.",
                        5000
                    );
                }
            );
