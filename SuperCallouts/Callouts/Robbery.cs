...
{
    [CalloutInfo("Robbery", CalloutProbability.High)]
    internal class Robbery : Callout
    {
        ...
        public override bool
            OnCalloutAccepted() // Let's take CarAccident2 and twist it up a bit. Work smarter not harder :D
        {
            ...
            SimpleFunctions.SpawnNormalCar(out _cVehicle2, _spawnPoint);
                ...
                switch (choices)
                {
                    ...
                    case 3:
                        GameFiber.StartNew(delegate
                        {
                            ...
                            NativeFunction.CallByName<uint>("TASK_COMBAT_PED", _rude2, Game.LocalPlayer.Character, 0, 1);
                            SimpleFunctions.SetWanted(_victim, true);
