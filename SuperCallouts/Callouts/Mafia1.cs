...
internal class Mafia1 : Callout
{
    ...
    public override bool OnBeforeCalloutDisplayed()
    {
        ...
        Functions.PlayScannerAudioUsingPosition("ATTENTION_ALL_SWAT_UNITS_01 WE_HAVE CRIME_BRANDISHING_WEAPON_01 IN_OR_ON_POSITION", _callPos);
    ...
    private void LoadRaid()
    {
        ...
        foreach (var entity in _vehicles.Where(entity => entity))
            ...
            {
                entity.IsPersistent = true;
                entity.Metadata.searchTrunk = "~r~multiple pallets of cocaine~s~, ~r~hazmat suits~s~, ~r~multiple weapons~s~, ~y~bags of cash~s~";
            }
    }
