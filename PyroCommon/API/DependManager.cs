...
internal static class DependManager
{
    ...
    internal static bool CheckDepends()
    {
        ...
        if (missingDepend.Length > 0)
        {
            ...
            Game.DisplayNotification("new_editor", "warningtriangle", $"~r~{plugName}", "~y~Not Loaded!", "Plugin is installed incorrectly! Please see the RagePluginHook.log! Visit https://dsc.gg/ulss for help!");
            return false;
        }
